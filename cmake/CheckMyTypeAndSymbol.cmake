...
if (BUILD_WITH_COMPILER_PRECHECK AND WIN32)
    ...
    check_include_file ("lm.h" HAVE_LM_H)
    ...
    check_include_file ("sys/callout.h" HAVE_SYS_CALLOUT_H)
    ...
    check_include_file ("sys/osd.h" HAVE_SYS_OSD_H)
...
if (BUILD_WITH_COMPILER_PRECHECK AND WIN32)
    set (HAVE__BEGINTHREADEX TRUE)
    set (HAVE__CPUTS TRUE)
    set (HAVE__GETCH TRUE)
    set (HAVE__GET_OSFHANDLE TRUE)
    set (HAVE__OPEN_OSFHANDLE TRUE)
    set (HAVE_IN_ADDR_T FALSE)
    set (HAVE_IP_PKTINFO FALSE)
    set (TIME_WITH_SYS_TIME FALSE)
else ()
    check_by_try_compile(HAVE__BEGINTHREADEX)
    check_by_try_compile(HAVE__CPUTS)
    check_by_try_compile(HAVE__GETCH)
    check_by_try_compile(HAVE__GET_OSFHANDLE)
    check_by_try_compile(HAVE__OPEN_OSFHANDLE)
